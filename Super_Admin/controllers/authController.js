...
async function login(req, res, next) {
  try {
    ...
    // Generate a JWT for the super admin
...
async function approveVendor(req, res, next) {
  try {
    ...
    return res.json({
      message: 'Vendor approved by super admin',
      vendor: {
        id: vendor.id,
...
async function rejectVendor(req, res, next) {
  try {
    ...
    return res.json({
      message: 'Vendor rejected by super admin',
      vendor: {
        id: vendor.id,
        shopName: vendor.shopName,
        ownerName: vendor.ownerName,
...
/**
 * Get all vendor products (Super Admin can see all products from all vendors)
...
async function getAllVendorProducts(req, res, next) {
  try {
    ...
    // Build query filter (no vendorId restriction - super admin can see all)
    const filter = {};
